            ...
            <div className='col-lg-10 col-xl-7'>
              <div className='text-center'>
                <div className='fs-4 mb-4 fst-italic'>
                  "Working with Start Bootstrap templates has saved me tons of development time when building new
                  projects! Starting with a Bootstrap template just makes things easier!"
                </div>
            ...
            <div className='col-lg-8 col-xl-6'>
              <div className='text-center'>
                ...
                <p className='lead fw-normal text-muted mb-5'>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque fugit ratione dicta mollitia. Officiis
                  ad.
                </p>
              </div>
            </div>
            ...
            <div className='col-lg-4 mb-5'>
              <div className='card h-100 shadow border-0'>
                ...
                <div className='card-body p-4'>
                  ...
                  <p className='card-text mb-0'>
                    This text is a bit longer to illustrate the adaptive height of each card. Some quick example text to
            ...
            <div className='col-lg-4 mb-5'>
              <div className='card h-100 shadow border-0'>
                ...
                <div className='card-body p-4'>
                  <div className='badge bg-primary bg-gradient rounded-pill mb-2'>News</div>
                  <a className='text-decoration-none link-dark stretched-link' href='#!'>
                    <h5 className='card-title mb-3'>The last blog post title is a little bit longer than the others</h5>
                  </a>
                  <p className='card-text mb-0'>
